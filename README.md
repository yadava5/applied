...
green. It went from 610 to 0 on that day, and **60 messages about real applications
...
| **Testing** | Playwright `^1.62.1` (24 spec files under `apps/web/tests/e2e/`) |
...
| **Web e2e** | Playwright | 24 spec files — auth, beta, boot, connect, dashboard, demo, file-application, import, inbox-geometry, landing, navigation, production, removed-rows, review-groups, review-picker, row-removal, sample-inbox, scan-correct, security-headers, session-edge, settings, shell, smoke, stage-focus |
