...
**And read it knowing the number went DOWN on purpose.** It was 93.05% on 2026-08-22 and is 91.65%
...
by recruiting teams with no knowledge of this repository. 91.65% is the first number here that was
not partly graded by the person who set the exam.

| | measured 2026-08-22 |
| --- | --- |
| Correct | **15,599 of 17,020 — 91.65%** |
| Wrong | **401** |
| **Wrong AND stated to the user as fact** | **119** |
| Abstained (below the 0.70 review floor, the product says nothing) | **1,020** |
| Board: cards / splits / merges / noise / misrouted review | **9,177 / 5 / 0 / 2 / 0** |
...
**5 applications did end up on two cards each**, and the real wording that causes it is ordinary: an
