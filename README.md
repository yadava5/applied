...
**30 messages did MINT a card that should not exist**, and that number is not a fix — read it with the
...
**Wrong verdicts stated as fact went 464 to 30.** There was no such thing as a wrong-but-hedged
