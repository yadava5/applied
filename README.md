...
| **Web e2e** | Playwright | 23 spec files — auth, beta, boot, connect, dashboard, demo, file-application, import, inbox-geometry, landing, navigation, production, review-groups, review-picker, sample-inbox, scan-correct, security-headers, session-edge, settings, shell, smoke, stage-focus |
