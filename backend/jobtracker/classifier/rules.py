...
PATTERNS: dict[EmailCategory, CategoryPatterns] = {
    ...
    EmailCategory.APPLIED: CategoryPatterns(
        ...
        negative=[
            ...
            r"congratulations on completing",
            r"your course",
            # Marketing/promotional exclusions
            r"(discount|promo|sale|deal|offer|savings|coupon|off)",
            r"(shop|buy|order|cart|checkout|purchase)",
            r"(unsubscribe|opt.out|preferences)",
            ...
            r"stream(ing)?",
            r"(nfl|nba|nhl|sports|game)",
            r"travel|tour|hotel|flight|booking",
            r"irctc",
            r"goat\.com",
            r"fubo",
            r"myntra",
