...
set the full cascade scores **0.9686** macro-F1 against the rules layer's
**0.9896** in the same run, so the learned layers make it worse by −0.0210
(`docs/ML_PROMOTION_POLICY.md`). Both figures are one measurement, taken
2026-09-08, and are quoted as a pair for that reason.
